...
INSTALL(CODE "SET(INSTALL_PYIDL_DIR ${MED_salomepythondir})") # R1 CHECK
  IF(WINDOWS)
    INSTALL(CODE "SET(INSTALL_PYIDL_DIR ${MED_salomescript_PYTHON})") # R1 CHECK
  ENDIF(WINDOWS)
...
MACRO(OMNIORB_ADD_MODULE MYMODULE MYIDLFILES MYIDLCXXFLAGS)
  ...
  FOREACH(input ${MYIDLFILES})
    ...
    INSTALL(FILES ${input} DESTINATION ${MED_salomeidl_IDLS})
